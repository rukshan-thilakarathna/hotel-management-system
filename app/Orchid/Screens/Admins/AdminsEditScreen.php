...
use App\Orchid\Layouts\Admins\AdminsPasswordLayout;
use App\Orchid\Layouts\Admins\AdminsRoleLayout;
...
class AdminsEditScreen extends Screen
{
    /**
     * @var User
     */
    ...
    public function layout(): iterable
    {
        return [
            ...
            Layout::block(AdminsEditLayout::class)
            ...
            Layout::block(AdminsPasswordLayout::class)
                ->title(__('Password'))
            ...
            Layout::block(AdminsRoleLayout::class)
                ->title(__('Roles'))
