...
use App\Orchid\Layouts\Staff\StaffPasswordLayout;
use App\Orchid\Layouts\Staff\StaffRoleLayout;
...
class StaffEditScreen extends Screen
{
    ...
    public function layout(): iterable
    {
        return [
            ...
            Layout::block(StaffPasswordLayout::class)
                ->title(__('Password'))
            ...
            Layout::block(StaffRoleLayout::class)
                ->title(__('Roles'))
